...
class Lead(models.Model):
    ...
    phone = models.CharField(max_length=32, blank=True, verbose_name=_('Teléfono'))
    message = models.TextField(verbose_name=_('Mensaje'))
    source = models.CharField(max_length=64, null=True, blank=True, verbose_name=_('Fuente'))
    medium = models.CharField(max_length=64, null=True, blank=True, verbose_name=_('Medio'))
    campaign = models.CharField(max_length=64, null=True, blank=True, verbose_name=_('Campaña'))
