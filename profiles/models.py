...
class Profile(models.Model):
    ...
    postal_code = models.CharField(max_length=255, verbose_name=_('Código postal'))
    summary = models.CharField(max_length=255, verbose_name=_('Resumen'))
    phone = models.CharField(max_length=255, db_index=True, verbose_name=_('Teléfono'))
...
class Work(models.Model):
    ...
    end_field = models.DateField(verbose_name=_('Fecha de renuncia'))
...
class Education(models.Model):
    ...
    certification = models.CharField(max_length=255, verbose_name=_('Título o certificado'))
    start_year = models.PositiveSmallIntegerField(default=0, verbose_name=_('Año de inicio'))
    end_year = models.PositiveSmallIntegerField(default=0, verbose_name=_('Año de egreso'))
...
class Skill(models.Model):
    ...
    percentage = models.PositiveSmallIntegerField(default=0, verbose_name=_('Porcentaje de experiencia'))
    age = models.PositiveSmallIntegerField(default=0, blank=True, verbose_name=_('Años de experiencia'))
...
class SocialNetwork(models.Model):
    ...
    profile = models.ForeignKey(Profile, on_delete=models.SET_NULL, null=True, verbose_name=_('Perfil'))
    created = models.DateTimeField(auto_now_add=True, verbose_name=_('Fecha de creación'))
    updated = models.DateTimeField(auto_now=True, verbose_name=_('Última actualización'))
